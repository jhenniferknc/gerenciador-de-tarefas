...
public interface TarefaRestControllerAPI {
    ...
    ResponseEntity<TarefaResponseDTO> criarTarefa(
            @RequestBody(description = "Dados da nova tarefa") TarefaRequestDTO dto,
    ...
    ResponseEntity<TarefaResponseDTO> editarTarefa(
            @Parameter(name = "id", description = "ID da tarefa", required = true, in = ParameterIn.PATH) UUID id,
            @RequestBody(description = "Dados atualizados da tarefa") TarefaUpdateRequestDTO dto,
            @Parameter(hidden = true) Usuario usuarioLogado
    );
    ...
    ResponseEntity<TarefaResponseDTO> buscarTarefa(
            @Parameter(name = "id", description = "ID da tarefa", required = true, in = ParameterIn.PATH) UUID id,
            @Parameter(hidden = true) Usuario usuarioLogado
    );
